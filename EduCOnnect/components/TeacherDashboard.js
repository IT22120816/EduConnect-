  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <UploadingSection uploadProgress={uploadProgress} onCancel={handleCancelUpload} />
  ...
  <View style={styles.uploadingSection}>
    ...
    <View style={styles.uploadContainer}>
      <View style={styles.uploadTextContainer}>
        <Text style={styles.uploadTitle}>SpringBoot BackEnd for Beginners</Text>
...
const LecturesSection = ({ lectures }) => (
  <View style={styles.lecturesSection}>
    ...
    {lectures.map((lecture, index) => (
      <LectureCard key={index} title={lecture.title} duration={lecture.duration} />
    ))}
  </View>
);
